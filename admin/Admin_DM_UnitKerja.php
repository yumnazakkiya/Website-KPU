...
if (isset($_POST['tambah'])) {
    ...
    if ($divisi !== "") {
        ...
        $divisi = mysqli_real_escape_string($conn, $divisi);

        $insert = mysqli_query(
            $conn,
            "INSERT INTO master_divisi (unit_kerja) 
             VALUES ('$divisi')"
        );
        ...
        header("Location: Admin_DM_UnitKerja.php");
        exit;
    }
}
...
if (isset($_GET['hapus'])) {
    ...
    mysqli_query($conn, "DELETE FROM master_divisi WHERE id_unit_kerja = $id");
...
// Hitung total data
$totalQuery = mysqli_query($conn, "SELECT COUNT(*) as total FROM master_divisi");
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="submenu aktif" id="submenuDataMaster">
        ...
        <a href="Admin_DM_UnitKerja.php" class="item-submenu aktif">Unit Kerja / Divisi</a>
...
<div class="header-master">
    <span class="judul-master">Manage Unit Kerja/Divisi</span>
...
<table width="100%" class="tabel-master">
    ...
    <tr>
        ...
        <td>
            <button type="button"
                    class="tombol-ubah"
                    onclick="openEditModal(<?= $row['id_unit_kerja']; ?>, '<?= htmlspecialchars($row['unit_kerja']); ?>')">
                <i class="fa-solid fa-pen"></i>
            </button>

            <button type="button"
                    class="tombol-hapus"
                    onclick="openDeleteModal(<?= $row['id_unit_kerja']; ?>)">
...
<div id="modalTambah" class="modal">
    <div class="modal-content">
        ...
        <h3 style="margin-top:0;">Tambah Unit Kerja/Divisi</h3>
...
function openEditModal(id, nama) {
    ...
    document.getElementById("editDivisi").value = nama;
